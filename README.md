...
| 42 | OAuth login confirmation dialog + customer service restructure (email/Telegram/AI assistant placeholder) | 2026-04-11 |
| 43 | Payment expansion — GrabPay + Alipay reserved + Apple/Google Pay domain verified | 2026-04-11 |
| 44 | Model audit — removed tts-1-hd (OpenAI violation) + added Qwen3-235B / DeepSeek-V3.1 / Qwen2.5-VL-32B | 2026-04-11 |
| 45 | Telegram AI support bot — DeepSeek-V3 auto-reply + language selector (EN/ZH/MY/JP) | 2026-04-11 |
| 46 | Enterprise email support@anytokens.net via Cloudflare Email Routing | 2026-04-11 |
<!-- /COMPLETED_FEATURES -->
